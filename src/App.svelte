<script>
  ...
  let word, wordMap, started, misses, guessed, progress, progressText, missText, missCount, gameState;
  ...
  function keydown(event) {
    if (started && gameState === PLAYING_STATE && event.keyCode < 91 && event.keyCode > 64) {
...
<main>
  ...
  {:else}
    ...
    <label>Player 1, enter a word to be guessed:
